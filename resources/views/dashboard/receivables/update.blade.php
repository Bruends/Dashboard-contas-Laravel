    ...
    <div class="box">
      ...
      <div class="box-body">
          <div class="box box-info">
              ...
              <div class="box-body">
              <form action="{{ route('receivables.update') }}" method="POST" class="form">
                {{ csrf_field() }}
                  {{-- cliente --}}
                  <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-user"></i> Cliente *</span>
                  <input class="form-control" name="client" placeholder="Nome do Cliente" type="text" value="{{ $receivable->client }}">
                    </div>
                    <br>  
                    {{-- valor --}}
                    <div class="input-group">
                      <span class="input-group-addon">Valor em R$ *</span>
                      <input class="form-control" name="value" placeholder="Valor" type="number" value="{{ $receivable->value }}">
                    </div>
                    <br>
                    {{-- check boxes --}}
                    <div class="form-row">
                    ...
                    <small>data de vencimento: {{ $receivable->expiration_date }}
